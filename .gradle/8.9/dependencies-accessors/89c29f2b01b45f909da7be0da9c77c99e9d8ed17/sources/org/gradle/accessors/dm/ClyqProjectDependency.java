...
@NonNullApi
public class ClyqProjectDependency extends DelegatingProjectDependency {

    @Inject
    public ClyqProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
